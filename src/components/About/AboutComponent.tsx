...
const AboutComponent = () => (
  <section className="container mx-auto grid grid-cols-12 gap-4">
    <div className="pt-6 flex flex-col gap-3 col-start-2 col-end-12 text-stone-100 text-base lowercase">
      ...
      <p>
        I have a degree in Software Analysis and Development, which provided me
        with a deep understanding of software engineering principles. Based on
        this, I pursued an MBA in Software Engineering, honing my strategic
      ...
      <p>
        ...
        aesthetically pleasing but also optimized for speed, accessibility, and
